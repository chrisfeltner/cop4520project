...
To Graph the experiments, run the python notebook with jupyter-notebook.
...
jupyter-notebook getAllGraphs.ipynb

Run all cells in the notebook and graphs will save in figs/
